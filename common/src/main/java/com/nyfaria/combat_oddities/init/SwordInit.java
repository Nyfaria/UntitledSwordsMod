...
import com.nyfaria.combat_oddities.item.ability.BonemealAbility;
import com.nyfaria.combat_oddities.item.ability.BonusDamageAbility;
import com.nyfaria.combat_oddities.item.ability.ChargeCreepersOnHitAbility;
import com.nyfaria.combat_oddities.item.ability.ComboBonusAbility;
import com.nyfaria.combat_oddities.item.ability.DashAbility;
import com.nyfaria.combat_oddities.item.ability.EffectOnHitAbility;
import com.nyfaria.combat_oddities.item.ability.ExtraXpOnKillAbility;
import com.nyfaria.combat_oddities.item.ability.FlightAbility;
import com.nyfaria.combat_oddities.item.ability.FlintAndSteelAbility;
import com.nyfaria.combat_oddities.item.ability.GlassBreakDropAbility;
import com.nyfaria.combat_oddities.item.ability.HealPetOnUseAbility;
import com.nyfaria.combat_oddities.item.ability.HitParticleAbility;
import com.nyfaria.combat_oddities.item.ability.HoldEffectAbility;
import com.nyfaria.combat_oddities.item.ability.HoldParticleAbility;
import com.nyfaria.combat_oddities.item.ability.IgniteAuraAbility;
import com.nyfaria.combat_oddities.item.ability.IgniteOnHitAbility;
import com.nyfaria.combat_oddities.item.ability.KillPlantsOnHitAbility;
import com.nyfaria.combat_oddities.item.ability.LaunchUpAbility;
import com.nyfaria.combat_oddities.item.ability.LightningStrikeAbility;
import com.nyfaria.combat_oddities.item.ability.NoDamageToTypeAbility;
import com.nyfaria.combat_oddities.item.ability.PlaceLavaOnHitAbility;
import com.nyfaria.combat_oddities.item.ability.ShatterChanceAbility;
import com.nyfaria.combat_oddities.item.ability.ShootFireballAbility;
import com.nyfaria.combat_oddities.item.ability.ShootProjectileAbility;
import com.nyfaria.combat_oddities.item.ability.SpeedOnHitAbility;
import com.nyfaria.combat_oddities.item.ability.StripLogAbility;
import com.nyfaria.combat_oddities.item.ability.SwordTargets;
import com.nyfaria.combat_oddities.item.ability.TameWolfAbility;
import com.nyfaria.combat_oddities.item.ability.ThrowEnderPearlAbility;
import com.nyfaria.combat_oddities.item.ability.ThunderstormAbility;
...
public class SwordInit {
    ...
    public static final RegistryObject<Item, AbilitySwordItem> ACID_EDGE = registerSword("acid_edge", Tiers.IRON, 3, -2.4F,
            ...
            new ShootProjectileAbility(40, true, "While it rains, use to spit acid", ProjectileVariant.ACID_PIECE,
    ...
    public static final RegistryObject<Item, AbilitySwordItem> CHARGED_GREATBLADE = registerSword("charged_greatblade", Tiers.DIAMOND, 4, -2.6F,
            new ShootProjectileAbility(40, false, "Use to fire a charged bolt", ProjectileVariant.CHARGED_BULLET,
    ...
    public static final RegistryObject<Item, AbilitySwordItem> CORROSIVE_SABER = registerSword("corrosive_saber", Tiers.IRON, 3, -2.4F,
            ...
            new ShootProjectileAbility(40, false, "Use to fire a corrosive bolt", ProjectileVariant.CORROSIVE_BOLT,
                    p -> p.damage(4.0F).effect(MobEffects.POISON, 80, 0).impactParticle(ParticleTypes.SNEEZE)));
    ...
    public static final RegistryObject<Item, AbilitySwordItem> CYCLONE_BLADE = registerSword("cyclone_blade", Tiers.DIAMOND, 3, -2.4F,
            ...
            new ShootProjectileAbility(60, false, "Use to hurl a cyclone burst", ProjectileVariant.CORROSIVE_BOLT,
    ...
    public static final RegistryObject<Item, AbilitySwordItem> FLUORESCENT_ZAPPER = registerSword("fluorescent_zapper", Tiers.IRON, 3, -2.4F,
            new ShootProjectileAbility(30, false, "Use to fire a zapping beam", ProjectileVariant.ZAPPING_BEAM,
    ...
    public static final RegistryObject<Item, AbilitySwordItem> FORGED_BLADE = registerSword("forged_blade", Tiers.DIAMOND, 3, -2.4F,
            new ShootProjectileAbility(40, false, "Use to sling molten metal", ProjectileVariant.CHARGED_BULLET,
    ...
    public static final RegistryObject<Item, AbilitySwordItem> MAUVE_TAUPE_SWORD = registerSword("mauve_taupe_sword", Tiers.IRON, 3, -2.4F,
            ...
            new ShootProjectileAbility(30, false, "Use to fling a shard", ProjectileVariant.SHARD,
    ...
    public static final RegistryObject<Item, AbilitySwordItem> SWORD_OF_SHARDS = registerSword("sword_of_shards", Tiers.IRON, 3, -2.4F,
            new ShootProjectileAbility(25, false, "Use to loose a damaging shard", ProjectileVariant.SHARD,
    ...
    public static final RegistryObject<Item, AbilitySwordItem> VIOLET_ELECTROCUTER = registerSword("violet_electrocuter", Tiers.DIAMOND, 3, -2.4F,
            new ShootProjectileAbility(30, false, "Use to fire a violet beam", ProjectileVariant.ZAPPING_BEAM,
