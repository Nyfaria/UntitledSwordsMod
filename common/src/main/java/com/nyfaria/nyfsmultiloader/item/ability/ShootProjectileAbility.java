...
public class ShootProjectileAbility implements SwordAbility {
    ...
    public ShootProjectileAbility(int cooldownTicks, boolean requiresRain, String description, Consumer<EnergyProjectile> config) {
    ...
    public boolean onUse(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide()) {
            ...
            projectile.setItem(new ItemStack(stack.getItem()));
